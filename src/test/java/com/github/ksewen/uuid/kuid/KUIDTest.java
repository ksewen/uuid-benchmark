...
public class KUIDTest {
  ...
  @Test
  public void test() {
    KUID kuid = KUID.randomKUID(ThreadLocalRandom.current());
  ...
  public void bloomTest() {
    BloomFilter<CharSequence> bloomFilter =
        BloomFilter.create(Funnels.stringFunnel(Charset.forName("UTF-8")), 10000000);
    int repeat = 0;
    ...
    System.err.println("repetition count: " + repeat);
  }

  @Test
  public void bloomTestMultiThread()
      throws ExecutionException, InterruptedException, TimeoutException {
    BloomFilter<CharSequence> bloomFilter =
        BloomFilter.create(Funnels.stringFunnel(Charset.forName("UTF-8")), 10000000);
    final AtomicInteger repeat = new AtomicInteger();
    ThreadPoolExecutor executor =
        new ThreadPoolExecutor(20, 20, 1, TimeUnit.MINUTES, new ArrayBlockingQueue(1));
    ...
    System.err.println("repetition count: " + repeat.intValue());
  }
